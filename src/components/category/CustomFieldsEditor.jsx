...
const CustomFieldsManager = ({ userFields, onAdd, onUpdate, onDelete, isDarkMode = false }) => {
            ...
            <table className="w-full">
              ...
              <tbody className={`divide-y ${isDarkMode ? 'divide-gray-700' : 'divide-gray-200'}`}>
                {userFields.map((field) => (
                  <tr key={field.user_field_id} className={`hover:${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'}`}>
