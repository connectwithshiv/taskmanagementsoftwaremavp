...
const App = () => {
  ...
  // Load categories whenever needed
  useEffect(() => {
  ...
  const handleNavigate = (pageId) => {
    // Handle worksheet builder specially
    if (pageId === 'worksheet-builder') {
  ...
  // Handle worksheet builder close
  const handleCloseWorksheetBuilder = () => {
    setShowWorksheetBuilder(false);
    // Refresh categories in case any were updated
    loadCategories();
  };
